...
[The front-end for Lokaal Beslist](lokaalbeslist.lblod.info/), a site that uses linked data to empower everyone in Flanders to consult the decisions made by their local authorities.
...
![Data Alignment Analysis]("./../docs/analysis-Lokaal Beslist.png)
