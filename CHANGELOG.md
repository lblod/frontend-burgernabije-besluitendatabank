...
- [#207](https://github.com/lblod/frontend-burgernabije-besluitendatabank/pull/207) Add max height to container to it will be able to scroll on mobile by ([@Andresdev02](https://github.com/Andresdev02))
- [#208](https://github.com/lblod/frontend-burgernabije-besluitendatabank/pull/208) Show the location level instead of hardcoded gemeente by ([@Andresdev02](https://github.com/Andresdev02))
- [#209](https://github.com/lblod/frontend-burgernabije-besluitendatabank/pull/209) Feature/update ember and ember data to the new lts by ([@Andresdev02](https://github.com/Andresdev02))
- [#210](https://github.com/lblod/frontend-burgernabije-besluitendatabank/pull/210) Remove webpack-bundle-analyzer by ([@Andresdev02](https://github.com/Andresdev02))
